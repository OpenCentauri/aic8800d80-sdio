...
static int rwnx_open(struct net_device *dev)
{
    ...
    if (rwnx_hw->vif_started == 0)
    {
       ...
       if (rwnx_get_chipid(rwnx_hw) == PRODUCT_ID_AIC8800DC || rwnx_get_chipid(rwnx_hw) == PRODUCT_ID_AIC8800DW) {
